...
var lsFusion = {
    ...
    filtering: function () {
        var filter_cont_active = document.querySelectorAll('.filtering-active');
        ...
        function filterActive() {
            ...
            if (param.length > 0) {
                filter_cont_active[0].classList.add('active-filter');
                compareFilterActive(param);
            } else {
                var items = document.querySelectorAll('.filtering-item');
                filter_cont_active[0].classList.remove('active-filter');
                for (var i = 0; i < items.length; i++) {
                    items[i].classList.remove('item_active-filter');
                }
            }
        }
            ...
            for (var i = 0; i < items.length; i++) {
                for (var k = 0; k < param.length; k++) {
                    ...
                    if (check == 'all') {
                        ...
                        items[i].classList.add('item_active-filter');
                        break;
                    } else {
                        items[i].classList.remove('item_active-filter');
                    }
        ...
        function filterSort() {
            ...
            if (param.length > 0 && def_init) {
                ...
                mixer.sort('enable:asc priority:asc default:desc');
